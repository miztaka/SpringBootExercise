...
public class MockSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private final static Log log = LogFactory.getLog(MockSecurityConfig.class);
    ...
    public JwtDecoder jwtDecoder() {
    	return new GoogleIdTokenDecoderMock();
    }
    
    @Override
    protected void configure(HttpSecurity http) throws Exception {
    	log.info("mock configure start...");
        http
    		.exceptionHandling()
    	.and()
    		.csrf().disable()
    	...
    	.and()
    		...
    		.jwt()
//    	.and()
//    		.authenticationProvider(new AuthenticationProviderMock())
    		;
